...
<template>
  <div ref="target" class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-6 main-class">
    <div 
    ...
    >
      <div class="text-center mb-10">
        <h2 class="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-3 main-text">Get in <span>Touch</span></h2>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-7">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-7">
          ...
          >
            ...
            <label 
              for="name"
              class="absolute left-5 -top-2.5 text-sm text-gray-500 transition-all duration-300 transform bg-white px-2
        ...
        <div 
          class="relative"
          :class="{'transform scale-[1.02] transition-transform': activeField === 'subject'}"
        >
          <input 
            type="text" 
        ...
        <div 
          class="relative"
          :class="{'transform scale-[1.02] transition-transform': activeField === 'message'}"
        >
          <textarea 
